...
import memory_manager as MemoryManager
...
class CodeGen(object):
    def __init__(self):
        ...
        self.output_file = os.path.join(os.path.dirname(script_dir), "output", "intermediate_code.txt")
    ...
    # called at the end of an assign statement
    # clear stacks to make room for the next assign statement
    ...
    # add the lable 3 address code for jump
