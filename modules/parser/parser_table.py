...
productions = (
    ...
    "DECIMAL",                              # 34
    "( Expression )",                       # 35
    "if ( Condition ) Statement-body Conditional-nest",      # 36
    "ID Rel-op Expression Compound-condition",               # 37
    "Log-op Condition",                     # 38
    "EPSILON",                              # 39
    "<=",                                   # 40
    ">=",                                   # 41
    ...
    "Elif-stmt",                            # 52
    "Else-stmt",                            # 53
    "if ( Condition ) Statement-body else Conditional-nest",      # 54
    "EPSILON",                              # 55
    "else Statement-body",                  # 56
    "return Return-type ;",                 # 57
    "ID",                                   # 58
    "NUMBER",                               # 59
    "LETTER",                               # 60
...
parsing_table = (
    ...
    (64,    64,    64,    64,     64,    64,    64,    64,    64,    64,    64,    64,    64,    64,    64,    64,    64,    64,    64,    64,    64,    64,    64,    64,    64,    50,    64,    64,    64,     64,     64,    63), # 23 Conditional-nest
    (64,    64,    64,    64,     64,    64,    64,    64,    53,    64,    64,    64,    64,    64,    64,    64,    52,    64,    64,    64,    64,    64,    64,    64,    64,    53,    64,    64,    64,     64,     64,    63), # 24 Condition-body
