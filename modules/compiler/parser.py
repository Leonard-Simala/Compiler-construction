...
from parse_table import non_terminal_to_missing_construct
from parse_table import productions
from parse_table import terminal_to_col
from parse_table import non_terminal_to_row
from parse_table import parsing_table
from icg import CodeGen
...
class Parser(object):
    ...
    def parse(self):
        ...
        while True:
            ...
            if X.startswith("#CG"):           # X is an action symbol for code generator
